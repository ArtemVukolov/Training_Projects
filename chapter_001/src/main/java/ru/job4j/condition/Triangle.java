...
//    функция exist будет ли работать при треугольники со сторонами 1 1 3 ? Такой треугольник можно построить ?
// Старайтесь никогда не использовать длинные операторы | , только короткие || , длинные нужны для битовых операций
